class IbsWeb::PersonnelsController < ApplicationController
  layout "ibs_web"
  ...
  private
    ...
    def personnel_params
      params.require(:personnel).permit(:first_name, :last_name, :salutation, :mailing_list, :formally_affiliated, :informally_affiliated, :ibs_retiree, :ibs_rostered, :notes, :research_interests, :skills, :biography, :employee_id)
    end
end
